...
Pipeline running at ${CONCOURSE_URL}/nxlog-boshrelease

Setup pipeline in Concourse
---------------------------

```
fly -t snw c -c pipeline.yml --vars-from credentials.yml nxlog-boshrelease --paused=false
```
...
```
fly -t snw configure -c ci_image/pipeline.yml --vars-from credentials.yml nxlog-boshrelease-image --paused=false
```
